...
import { X, Save, RefreshCw, Settings as SettingsIcon, Key, Cpu, Globe, Eye, EyeOff } from 'lucide-react';
import { Button } from './ui/Button';
import { LLMSettings, LLMModel, ProviderConfig } from '../types';
import { getAvailableModels } from '../lib/model-helper';
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
                <input
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-100 focus:outline-none focus:ring-1 focus:ring-primary pr-10"
                />
                <button 
                    type="button"
